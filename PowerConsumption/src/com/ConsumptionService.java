...
public class ConsumptionService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = consumptionObj.insertConsumption(
				...
				request.getParameter("PreviousUnits"),
				request.getParameter("CurentUnits"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = consumptionObj.updateConsumption(
		    		...
		    		paras.get("PreviousUnits").toString(),
		    		paras.get("CurentUnits").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 Map paras = getParasMap(request); 		 
		 String output = consumptionObj.deleteConsumption(paras.get("cID").toString());  		 
		 response.getWriter().write(output);
	}
